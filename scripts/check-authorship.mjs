...
// §3-6 최종 검증표
const EXPECTED = {
  "li-yiling": { ssci: 4, kci: 10, book: 0 },
  "kim-jeeyeon": { ssci: 5, kci: 4, book: 1 },
  "jo-wooyong": { ssci: 5, kci: 3, book: 0 },
  "kim-sanghwa": { ssci: 2, kci: 3, book: 0 },
  "kim-mingyung": { ssci: 2, kci: 2, book: 1 },
  "kim-hyejeong": { ssci: 1, kci: 4, book: 0 },
  "hwang-inseo": { ssci: 1, kci: 3, book: 0 },
  "kim-wookyoung": { ssci: 1, kci: 2, book: 0 },
  "jung-hyunwoo": { ssci: 0, kci: 3, book: 0 },
  "yoon-yeohong": { ssci: 3, kci: 0, book: 0 },
  "yoon-yeolim": { ssci: 1, kci: 2, book: 0 },
